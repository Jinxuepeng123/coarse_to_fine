...
def weights_init(m):   #该函数基本实现原理还未知
...
def train(config):
	...
	DCE_net = model.enhance_net_nopool().cuda()    #进入到网络编写阶段
...
if __name__ == "__main__":
	...
	#parser.add_argument('--num_workers', type=int, default=4)  #不清楚干什么的
	...
	config = parser.parse_args()   #应该是基本代码
